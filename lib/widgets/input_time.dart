...
class SInputTime extends StatefulWidget {
  const SInputTime({
    this.hintText,
    this.labelText,
    this.validator,
  ...
  @override
  State<SInputTime> createState() => _SInputTimeState();
}

class _SInputTimeState extends State<SInputTime> {
  ...
  @override
  void didUpdateWidget(SInputTime oldWidget) {
